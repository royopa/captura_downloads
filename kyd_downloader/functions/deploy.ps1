...
gcloud functions deploy kyd-generic-download --entry-point gcf_generic_download --memory 1024MB --runtime python37 --trigger-topic kyd-storage-config --env-vars-file .env.yaml --project=kyd-storage-001
